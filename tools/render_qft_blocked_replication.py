...
Data dependencies (loss_history/ JSON is gitignored):
  qft               results/div2k_8q_pca_vs_block_dct/by_basis/qft/loss_history/
                    (canonical cell; re-train via experiments/div2k_8q_pca_vs_block_dct.py)
  qft_identity      results/qft_identity_init/div2k_8q/_runs/run1/loss_history/
                    (not in this PR; requires the qft_identity_init ablation cell,
                     produced by experiments/quickdraw_pca_vs_block_dct.py family
                     with --bases qft_identity — landing in a follow-up PR)
  blocked_8         results/div2k_8q_pca_vs_block_dct/by_basis/blocked_8/loss_history/
                    (canonical cell; re-train as for qft)
  qft_frozen_outer  results/qft_freeze_sweep/div2k_8q/_runs/freeze_outer/loss_history/
                    (produced by experiments/qft_freeze_sweep.py in this PR)
"""
...
LOSS_HISTORY = {
    ...
    "qft_frozen_outer": "results/qft_freeze_sweep/div2k_8q/_runs/freeze_outer/loss_history/qft_freeze_outer_loss.json",
}
